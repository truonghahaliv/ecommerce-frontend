...
export default {
    ...
    methods: {
        fetchPermission() {
            axios
                .get(`http://127.0.0.1:8000/api/permissions/${this.id}`)
                .then(response => {
        ...
        updatePermission() {
            ...
            axios
                .put(`http://127.0.0.1:8000/api/permissions/${this.id}`, this.permission, 
            )
                ...
                .catch(error => {
                    ...
                    if (error.response) {
                        ...
                        this.errorList = error.response.data.errors || error.response.data.message || 'An error occurred';
